...
class mvp_facebook_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_facebook_widget', 'description' => esc_html__('A widget that displays a Facebook Like Box.', 'the-league') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_facebook_widget' );

		/* Create the widget. */
		parent::__construct( 'mvp_facebook_widget', esc_html__('The League: Facebook Widget', 'the-league'), $widget_ops, $control_ops );
	}
