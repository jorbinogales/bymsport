<div id="mvp-fly-wrap">
			...
			<div class="mvp-fly-top-in">
				<div id="mvp-fly-logo" class="left relative">
					<?php if(get_option('mvp_logo')) { ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(get_option('mvp_logo')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" /></a>
					<?php } else { ?>
	...
	<div id="mvp-fly-soc-wrap">
		<span class="mvp-fly-soc-head"><?php esc_html_e( 'Connect with us', 'the-league' ); ?></span>
