<?php
/**
 * Plugin Name: Tag Feat Widget
 */

add_action( 'widgets_init', 'mvp_home_tagfeat_load_widgets' );

function mvp_home_tagfeat_load_widgets() {
	register_widget( 'mvp_home_tagfeat_widget' );
}

class mvp_home_tagfeat_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_home_tagfeat_widget', 'description' => esc_html__('A widget that displays a list of posts from a tag of your choice.', 'the-league') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_home_tagfeat_widget' );

		/* Create the widget. */
		parent::__construct( 'mvp_home_tagfeat_widget', esc_html__('The League: Tag Feat Widget', 'the-league'), $widget_ops, $control_ops );
	}
