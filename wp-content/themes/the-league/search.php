		...
		<div class="mvp-main-body-out2 relative">
			<div class="mvp-main-body-in2">
				<div class="mvp-main-body-blog left relative">
					<h1 class="mvp-sec-head"><span class="mvp-sec-head"><?php esc_html_e( 'Search results for', 'the-league' ); ?> "<?php the_search_query() ?>"</span></h1>
					<ul class="mvp-main-blog-wrap left relative infinite-content">
							...
							<div class="mvp-search-text">
								<p><?php esc_html_e('Sorry, your search did not match any entries.', 'the-league') ?></p>
							</div><!--mvp-search-text-->
						<?php endif; ?>
